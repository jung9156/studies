...
![image](https://user-images.githubusercontent.com/60081212/93563808-96abc580-f9c3-11ea-8d5a-f002c04a6a54.png)
...
![블랙박스사진](![image](https://user-images.githubusercontent.com/60081212/93564009-f4401200-f9c3-11ea-8292-d5d89baee3a0.png)
![홈페이지사진1](![image](https://user-images.githubusercontent.com/60081212/93564048-05891e80-f9c4-11ea-9f12-e6b00d3c8c70.png)
![카드첫클릭](![image](https://user-images.githubusercontent.com/60081212/93564075-146fd100-f9c4-11ea-8e43-3d8ebc3fa2ee.png)

```bash
보내온 영상 썸내일을 클릭하게 되면 블랙박스 내 센서로 영상 및 영상정보들이 자동으로 저장되어진 것을 확인할 수 있습니다.
```
![HowToUse1](![image](https://user-images.githubusercontent.com/60081212/93564112-218cc000-f9c4-11ea-98b4-9920354597bc.png)
```bash
초기 상태는 신고 미접수로 아직 스마트 국민제보 사이트에 민원을 접수하기 전 단계입니다
```
![image](https://user-images.githubusercontent.com/60081212/93564143-2d788200-f9c4-11ea-9c67-e847b8aeb191.png)
```bash
제보 상세보기에서는 다음의 빈칸들을 작성 후 저장하기를 누릅니다
```
![HowToUse4](![HowToUse5](https://lab.ssafy.com/s03-webmobile3-sub2/s03p12a211/uploads/bda41e62d757f5b8e0e352dd5b0b95c2/HowToUse5.png)
```bash
영상을 다운로드 받은 후 하단의 스마트 국민제보로 신고하러 가기 버튼을 누릅니다.
```
![HowToUse5](![image](https://user-images.githubusercontent.com/60081212/93564191-3ff2bb80-f9c4-11ea-8f41-744494989277.png)
```bash
스마트 국민제보 사이트에서 회원가입 후 로그인을 합니다
```
![HowToUse6](![image](https://user-images.githubusercontent.com/60081212/93564230-50a33180-f9c4-11ea-9826-e034781aaf48.png)
```bash
메인화면에 보이는 교통위반 버튼을 누릅니다.
```
![HowToUse7](![image](https://user-images.githubusercontent.com/60081212/93564240-53058b80-f9c4-11ea-8a0b-84a7e78e24df.png)
```bash
분노의 민원 제보목록에 저장된카드 를 보면서 1~8번 순서대로 교통위반신고 항목을 기입하고 신고하기 버튼을 누릅니다.
```
![HowToUse8](![image](https://user-images.githubusercontent.com/60081212/93564249-56007c00-f9c4-11ea-84fd-54ef590717f2.png)
```bash
